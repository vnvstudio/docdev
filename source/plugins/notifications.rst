...
If the plugin needs to create a new event for a notification which belongs to GLPI core.

The folowing example creates an event `plugin_exemple` for Ticket notifications.
